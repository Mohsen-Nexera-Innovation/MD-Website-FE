...
export const JOURNEY_SECTIONS: JourneySectionMeta[] = [
  ...
  },
  {
    ...
    audience: 'dentist',
    next: { id: 'promise', label: 'Choose Your Path', hint: 'Academic partners and value pillars' },
  },
  {
    id: 'promise',
    step: '05',
  ...
  },
  {
    ...
    step: '06',
    label: 'FAQ',
    storyBeat: 'E-commerce reassurance — how to shop, delivery, and authenticity before checkout.',
    businessValue: 'Reduces purchase friction and drives handoff to MD shop.',
    designMechanism: 'Accordion FAQ on light canvas; shop band + per-answer CTAs to shop and products.',
    maxClicks: '1 click → shop.mddental.com or /products',
    audience: 'both',
